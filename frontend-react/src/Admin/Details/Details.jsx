...
const Details = () => {
    ...
    <div className="lg:px-20 px-5">
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Card>
            <CardHeader
              title={<span className="text-gray-300"> Medical</span>}
            />
            <CardContent>
              <div className="space-y-4 text-gray-200">
                ...
                <div className="flex">
                  <p className="w-48">Medical Name</p>
                  <p className="text-gray-400">
                    {" "}
                    <span className="pr-5">-</span>{" "}
                    {restaurant.usersRestaurant?.name}
                ...
                <div className="flex">
                  <p className="w-48">Medicine Type</p>
                  <p className="text-gray-400">
                    {" "}
                    <span className="pr-5">-</span>{" "}
              ...
              <div className="space-y-3 text-gray-200">
                <div className="flex">
                  ...
                  <p className="text-gray-400">
                    {" "}
                    <span className="pr-5">-</span>
                    {restaurant.usersRestaurant?.contactInformation && restaurant.usersRestaurant?.contactInformation.email}
                  </p>
                </div>
                <div className="flex">
                  ...
                  <p className="text-gray-400">
                    ...
                    <span className="pr-5">-</span>
                    {" +91"}
                    {restaurant.usersRestaurant?.contactInformation && "+91" + restaurant.usersRestaurant?.contactInformation.mobile}
                  </p>
                </div>
  ...
  <div className="text-gray-400 flex items-center pb-3">
    ...
    {restaurant.usersRestaurant?.contactInformation?.linkedin && (
      <a
        className="ml-5"
        href={restaurant.usersRestaurant?.contactInformation?.linkedin}
        target="_blank"
        rel="noreferrer"
      >
    ...
    {restaurant.usersRestaurant?.contactInformation?.facebook && (
      <a
        className="ml-5"
        href={restaurant.usersRestaurant?.contactInformation?.facebook}
        target="_blank"
        rel="noreferrer"
      >
