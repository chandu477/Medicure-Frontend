            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="categoryId">Medicine Category</InputLabel>
                  <Select
                    id="category"
                    name="category"
              ...
              <Grid item xs={6}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="vegetarian">Is generic</InputLabel>
                  <Select
                    id="vegetarian"
                    name="vegetarian"
                    label="Is Vegetarian"
              ...
              <Grid item xs={6}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="seasonal">Can be delivered</InputLabel>
                  <Select
                    id="seasonal"
                    name="seasonal"
                    label="can be"
