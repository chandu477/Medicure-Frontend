...
const menu = [
  ...
  { title: "Add Medicines", icon: <ShopTwoIcon />, path: "/menu" },
  { title: "Medicine Category", icon: <CategoryIcon />, path: "/category" },
  { title: "Composition", icon: <FastfoodIcon />, path: "/ingredients" },
